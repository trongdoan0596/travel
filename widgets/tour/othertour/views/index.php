...
if(!empty($rows)){
      $i = 0;
      ?>
      <h6><?php echo Yii::t('app','Other tours');?> </h6>
            <div class="uk-grid">   
            <?php
              foreach($rows as $row){                          
                 $title = $row->title;                
                ...
                <div class="uk-width-1-3">
                     ...
                     ?>                      
                       <div class="boxinfo <?php echo $cls;?>">
                            <p class="title"><a href="<?php echo $url;?>"><?php echo $title;?></a></p>
                             ...
                             <div class="uk-grid">
                               <div class="uk-width-1-2">    
                                <p class="days"><?php echo $num_day;?> <?php echo Yii::t('app','Days');?></p>
                               </div>
                               <?php
                               if($row->price_from!=''){
                                ?>
                            ...
                            <p class="readmore">                            
                            <a class="btn btn-warning btnreadmore" href="<?php echo $url;?>"><?php echo Yii::t('app','Read more');?> <i class="uk-icon-caret-right"></i></a>                            
