...
<div class="boxhightlight">
              ...
              <div  class="uk-grid uk-container uk-container-center boximagehome">              
                <?php
                      ...
                      foreach($rows as $row){                          
                        ...
                        */                       
             ?>
                    <div data-uk-scrollspy="{cls:'<?php echo $fadetype;?>',delay:<?php echo $delay;?>, repeat: false}" class="boxitemhome itemhome-<?php echo $i;?>">
    ...
    <br /> <br /><br />
    <div class="viewall"><a href="<?php echo $urlall;?>"><?php echo  Yii::t('app','View more our tours');?></a></div>
</div>
</div>
 <?php
}
