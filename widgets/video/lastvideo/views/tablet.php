   ...
   <div class="uk-container uk-container-center"> 
           ...
           <?php echo  $introtxt;?>            
            ...
            <div class="uk-grid" >
                ...
                <div class="uk-width-2-6 viewall" style="text-align:left !important;"><a target="_blank" href="https://www.youtube.com/user/authentikvietnam"><?php echo  Yii::t('app','View all video');?></a></div>
           </div> 
    </div>   
</div>
 <!-- This is the modal -->
