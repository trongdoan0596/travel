...
if(!empty($rows)){ 
       ...
       $introtxt= "";$title= "";
       if(!empty($info)){
          $introtxt = strip_tags($info->introtxt);// HtmlPurifier::process(strip_tags($info->introtxt));
            ...
            <div>   
               <center>
                <div class="uk-position-relative uk-align-center slidenavbottom">           
                 ...
                 <div class="viewall" style="margin-top:10px;"><a href="<?php echo $urlindex;?>"><?php echo  Yii::t('app','View more');?></a></div>
                </center>  
            </div>   
        </div>
