             ...
             ?>
              <div class="uk-width-1-5" style="padding-bottom: 30px;text-align: center;">
                   <div class="circleusavatar">                               
                     ...
                     <div class="title"><a href="#"><?php echo $name;?></a></div>                  
                     <div class="datetxt"><?php  echo $date;?></div> 
              </div>
              <div class="uk-width-4-5" style="padding-bottom: 30px;">
                  ...
                  <div class="boxreplysubmit" id="boxreplysubmit<?php echo $ext_;?>">
                  ...
                  $form = ActiveForm::begin(
                        ...
                        <div class="uk-width-1-1">
                                <div class="uk-form-row">
                                  <?php echo $form->field($modelfrm,'message')->textarea(array('rows' =>4,'cols' =>50,'placeholder'=>Yii::t('app','Write message here').' ... '));?>
                                </div>
                        </div>
                        <div class="uk-width-1-1" style="margin-top: 14px;">
                                    <div class="uk-form-row">
                                      <?php echo $form->field($modelfrm,'fullname')->textInput(array('class' =>'form-control','placeholder'=>Yii::t('app','Full name')));?>
                                    </div>
                            </div>
                            <div class="uk-width-1-1" style="margin-top: 14px;">
                                    <div class="uk-form-row">
                                      <?php echo $form->field($modelfrm,'youremail')->textInput(array('class' =>'form-control','placeholder'=>Yii::t('app','Your e-mail')));?>
                                    </div>
                            </div>
                            <div class="uk-width-1-1" style="margin-top: 14px;">
                                     <div class="uk-form-row">
                                     <div style="width: 100%; text-align: left;white-space: nowrap;"><strong>Code anti-spam</strong> <?php echo Yii::t('app','You must type the characters of the image in the text box');?></div><br />
                            ...
                            <div class="uk-width-1-1" style="margin-top: 14px;text-align: center;" >
                            <?php 
                            echo Html::Button('<i class="uk-icon-edit"></i> '.Yii::t('app','Reply'),array('onclick' =>'ReplySubmit('.$ext_id.','.$id_ext.');','class' =>'btn btn-warning btncomment','name' =>'sendcommentreply'.$ext_,'id' =>'sendcommentreply'.$ext_));
                            ?>                             
                            </div>
                              <?php
                  ...
                  if(!empty($rs)){
                   ...
                   <?php
                        foreach($rs as $r){
                            $id_  = $r->id;
                            echo $this->render('_itemsub',array('row'=>$r));  
                        }
                        ?>
                         </div>
                   <?php
