                 ...
                 <div class="boxreply">
                  ...
                  $form = ActiveForm::begin(
                        ...
                        <div class="uk-width-1-1" style="margin-top: 6px;">
                            ...
                            <?php 
                            echo Html::Button('<i class="uk-icon-edit"></i> '.Yii::t('app','Reply'),array('onclick' =>'ReplySubmit('.$ext_id.','.$id_ext.');','class' =>'btn btn-warning btnsubcomment','name' =>'sendcommentreply'.$ext_,'id' =>'sendcommentreply'.$ext_));
                            ?>                             
                            </div>
                              <?php
