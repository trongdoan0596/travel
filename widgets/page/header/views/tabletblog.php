   ...
   <div class="uk-display-inline-block headicon">
            <div class="uk-grid">
                <div class="uk-width-3-5">
                     <ul class="uk-grid">
                      <li><b>Hotline:</b> <?php echo Yii::t('app','Hotline');?></li>
                    </ul>  
                </div>
                <div class="uk-width-2-5">
                    <ul class="uk-grid uk-float-right">
                         <li style="float: right;padding-left: 0px;"><a target="_blank" href="https://authentiktravel.es/"><img src="<?php echo Yii::$app->homeUrl;?>themes/web/img/flag/es.png" alt="Español" /> Español</a></li>
                         <li style="float: right;padding-left: 12px;"><a target="_blank" href="https://authentikvietnam.com"><img src="<?php echo Yii::$app->homeUrl;?>themes/web/img/flag/fr.png" alt="Français"/> Français</a></li>
