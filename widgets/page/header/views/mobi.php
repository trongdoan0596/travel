            ...
            <nav class="uk-navbar navbar-top">  
            	...
            	<div class="uk-navbar-center">
                 ...
                 <div class="uk-navbar-left" style="width: 100% !important;padding-left:10px !important;margin-top:-40px !important;">
                    <a target="_blank" href="https://authentikvietnam.com/"><img src="<?php echo Yii::$app->homeUrl;?>themes/web/img/flag/fr.png" alt="Français" /></a>
                    <a target="_blank" href="https://authentiktravel.es" style="margin-left:10px;"><img src="<?php echo Yii::$app->homeUrl;?>themes/web/img/flag/es.png" alt="Español" /></a>
                </div>
            </nav>
</div>
</div>
