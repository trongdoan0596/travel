...
if(!empty($rows)){ 
    ...
    ?>
     <div class="uk-container uk-container-center boxgioithieu">   
      <h1 class="uk-h1 uk-text-center" style="padding-bottom: 14px;"><a href="<?php echo $urlall;?>"><?php echo $info_ac->title;?></a></h1>
          <div class="uk-grid">            
              ...
              <div class="uk-width-1-2">
               <a href="<?php echo $urlall;?>"><img class="border-img-4" src="<?php echo Url::base();?>/themes/tablet/img/article/vietnam-travel-agency.jpg" alt="Vietnam travel agency" title="Vietnam travel agency" /></a>
             </div>
          </div> 
     </div>
     <?php
