...
if(!empty($rows)){ 
    ...
    ?>
      <div class="uk-container-center boxwhyus boxgioithieu" style="background:#e9ebee;padding-bottom: 10px;">       
                 ...
                 <a href="<?php echo $url_;?>" class="border-top-left-img-4"><img style="width: 100%;" src="<?php echo Url::base();?>/themes/web/img/article/vietnam-travel-agency.png" alt="Vietnam Travel Agency" title="Vietnam Travel Agency" /></a>           
             ...
             <?php
                       ...
                       foreach($rows as $row){                          
                             ...
                             <li><center>
                               ...
                               <p class="viewall" style="display: block; padding-top: 14px;padding-bottom: 14px;margin-top: 0px;"><a href="<?php echo $url_;?>"><?php echo  Yii::t('app','View more our concept');?></a></p>
                               </center>
                             </li>
                             <?php
                             $i++;
