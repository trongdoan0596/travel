...
if(!empty($rows)){
    $title_ext = Yii::t('app','Recent from Blog');
    $fulltxt   = "";
    if(!empty($info)){ 
         $title_ext = $info->title;//Html::encode($info->title);
...
<div class="lastblog">   
   <div class="uk-container uk-container-center"> 
            ...
            <div class="maincontentblog" data-uk-slideset="{default: 4,pauseOnHover:true,animation:'slide-horizontal',duration:200,autoplay:false}">
                               ...
                               <li>
                                    ...
                                    <p>
                                     ...
                                     <p style="text-align: right;">                                     
                                        <span style="text-align: right;width: 100%;"><?php echo Yii::t('app','Last update');?> <?php echo StringHelper::showDateMfr($row->last_update,1);?></span>
                                    </p>
                                </li>
                            <?php
                          }
                    ...
                    <div class="viewall"><a href="<?php echo $urlall;?>"><?php echo  Yii::t('app','See more');?></a></div>
                    <center>
