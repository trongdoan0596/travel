...
if(count($rs)){
        ...
        foreach($rs as $r){
                ...
                if($id== $r->parent_id){
                    ...
                    if($idsub==88){//Nord du Vietnam 88
                         //parent category = 45
                         $blogcat_id = 45;
                         $str_sub  .='<div class="uk-width-1-4">
                            <div class="uk-panel">
                              <a href="'.$url_sub.'" class="uk-text-uppercase titlemenu">'.strtoupper($r->title).'</a>
                              <br />';
                          ...
                          $str_sub .='</div></div>';            
                    }else if($idsub==89){//Centre du Vietnam 89
                           $str_sub  .='<div class="uk-width-1-4">
                            <div class="uk-panel">
                              <a href="'.$url_sub.'" class="uk-text-uppercase titlemenu">'.strtoupper($r->title).'</a>
                              <br />';
                          ...
                          $str_sub .='</div></div>';  
                    }else if($idsub==90 || $idsub==91){//Sud du Vietnam 90,Séjour balnéaire au Vietnam 91
                         ...
                         $strlao_cam .='<a href="'.$url_sub.'" class="titlemenu">'.strtoupper($r->title).'</a>';
                    }
