...
if(!empty($rows)){ 
    ...
    ?>
     <div class="uk-container uk-container-center homeabout">   
      <h1 class="titleindex" style="padding-bottom: 14px;"><a href="<?php echo $urlall;?>"><?php echo $info_ac->title;?></a></h1>
          <div class="uk-grid">
             ...
             <div class="uk-width-1-2">
               <a href="<?php echo $urlall;?>"><img class="border-img-4" src="<?php echo Url::base();?>/themes/tablet/img/article/agence-de-voyage-sur-mesure-au-vietnam.png" alt="Agence de voyage sur mesure au Vietnam" title="Agence de voyage sur mesure au Vietnam" /></a>
             </div>
