...
if(!empty($rows)){ 
    ...
    ?>
      <div class="uk-container-center boxwhyus boxgioithieu" style="background:#e9ebee;padding-bottom: 10px;">       
                 ...
                 <a href="<?php echo $url_;?>" class="border-top-left-img-4"><img style="width: 100%;" src="<?php echo Url::base();?>/themes/mobi/img/article/agence-de-voyage-sur-mesure-au-vietnam.png" alt="Agence de voyage sur mesure au Vietnam" title="Agence de voyage sur mesure au Vietnam" /></a>           
             ...
             <?php
                       ...
                       foreach($rows as $row){                          
                             ...
                             <li><center>
                               ...
                               <p class="viewall" style="display: block; padding-top: 14px;padding-bottom: 14px;margin-top: 0px;"><a href="<?php echo $url_;?>"><?php echo  Yii::t('app','Voir notre concept');?></a></p>
                               </center>
                             </li>
                             <?php
                             $i++;
