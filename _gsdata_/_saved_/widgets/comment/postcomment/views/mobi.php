...
?>
<center>
<a href="#modalcm" class="btn btn-warning writecomment" data-uk-modal><?php echo Yii::t('app','Un commentaire à laisser ?');?></a>
</center>
<div id="modalcm" class="uk-modal boxcoment">
    <div class="uk-modal-dialog">
        <a class="uk-modal-close uk-close"></a>
         <h2 class="title"> <?php echo Yii::t('app','Comment');?></h2>
            ...
            <?php $form  = ActiveForm::begin(
               ...
               <div class="uk-grid">
                        <div class="uk-width-1-1">
                                ...
                                <?php echo $form->field($model,'message')->textarea(array('style' =>'width: 100%;','rows' =>8,'placeholder'=>Yii::t('app','Write message here').' ... '));?>
                                </div>                        
                        </div>
                        <div class="uk-width-1-1">
                                 <div class="uk-form-row">
                                        <?php echo $form->field($model,'fullname')->textInput(array('class' =>'uk-form-large','placeholder'=>Yii::t('app','Full name')));?>
                                 </div>
                                 <div class="form-group">
                                        <?php echo $form->field($model,'youremail')->textInput(array('class' =>'uk-form-large','placeholder'=>Yii::t('app','Your e-mail')));?>
                                 </div>
                                 <div class="uk-form-row">  
                                  <?php echo $form->field($model,'verifyCode')->widget(Captcha::className(),array('template' =>'<div class="captchacode" align="center"><div class="col-lg">{input}</div><div class="col-lg">{image}</div></div>')); ?>
