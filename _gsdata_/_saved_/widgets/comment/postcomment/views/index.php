...
?>
<div id="boxcommentblog" class="uk-modal boxcoment">
    <div class="uk-modal-dialog">
        <a class="uk-modal-close uk-close"></a>
        <div class="boxcoment" id="boxcommentblog">
                ...
                <?php $form  = ActiveForm::begin(
                   ...
                   <div class="uk-grid">
                            <div class="uk-width-1-2">
                                    ...
                                    <?php echo $form->field($model,'message')->textarea(array('rows' =>10,'cols' =>50,'placeholder'=>Yii::t('app','Write message here').' ... '));?>
                                    </div>                        
                            </div>
                            <div class="uk-width-1-2">
                                     <div class="uk-form-row">
                                     ...
                                     <div class="uk-form-row">  
                                      <?php echo $form->field($model,'verifyCode')->widget(Captcha::className(),array('template' =>'<div class="captchacode"><div class="col-code">{input}</div><div class="col-img">{image}<br /><div>'.Yii::t('app','You must type the characters of the image in the text box').'</div></div></div>')); ?>
                                     </div>  
                            </div>                   
                    </div>
                      <?php
                          ...
                          echo $form->field($model,'itemext_id')->hiddenInput()->label(false);                      
                          ?>
                          <div align="center">
                          <?php
