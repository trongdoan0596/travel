...
if(!empty($rows)){ 
       ...
       $introtxt= "";$title= "";
       if(!empty($info)){
          $introtxt =  HtmlPurifier::process(strip_tags($info->introtxt));
          $title    = Html::encode($info->title);
       }
    ?>
   <div class="boxtraveller">    
      <h1 class="uk-h1 uk-text-center" style="margin-bottom: 0px;"><a href="<?php echo $urlindex;?>"><?php echo $title;?></a> </h1> 
            ...
            <div>   
               <center>
                <div class="uk-position-relative uk-align-center slidenavbottom">           
                 ...
                 <div class="viewall" style="margin-top:10px;"><a href="<?php echo $urlindex;?>"><?php echo  Yii::t('app','Voir tous les avis de nos voyageurs');?></a></div>
                </center>  
            </div>   
        </div>
