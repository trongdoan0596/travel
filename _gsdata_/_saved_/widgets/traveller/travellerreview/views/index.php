...
<div class="boxtraveller">   
   <div class="uk-container uk-container-center"> 
            <h5 class="uk-h1 uk-text-center" style="margin-bottom: 0px;"><a href="<?php echo $urlindex;?>"><?php echo $title;?></a></h5>  
            ...
            <div class="maincontenttraveller" data-uk-slideset="{default: 3,animation: 'scale',autoplayInterval:7000,duration:300,autoplay:false}">
                                         ...
                                         <center>
                                          ...
                                          <div class="infoitemtraveller">                        
                                               ...
                                               <!-- <p class="uk-text-muted">14 days in viet nam</p>-->
                                                <p class="shorttxt">                                                   
                                                    <?php echo HtmlPurifier::process($row->introtxt);?>                                                   
                                                </p>
                                           </div>
                    ...
                    <br />
                    <div class="viewall"><a href="<?php echo $urlindex;?>"><?php echo  Yii::t('app','Voir tous les avis de nos voyageurs');?></a></div>  
                    <center>
                            <ul class="uk-slideset-nav uk-dotnav uk-flex-center bottomslideset" style="width:100px;margin-top:0px;position: relative;padding-bottom: 30px !important;"></ul>
                    </center>
                    <br /><br />
             </div>          
    </div>   
