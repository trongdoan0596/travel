...
<div class="boxtraveller detailtour">   
   <div class="uk-container uk-container-center"> 
            <h2 class="uk-h1 uk-text-center" style="margin-bottom: 0px;"><a href="<?php echo $urlindex;?>"><?php echo $title;?></a></h2>             
           <?php echo Settinghome::widget(array('view'=>'showrating','total'=>$total));?><br />
            <div class="maincontenttraveller" data-uk-slideset="{default: 3,animation: 'scale', duration:200,autoplay:false}">
                    ...
                    <br />
                    <div class="viewall"><a href="<?php echo $urlindex;?>"><?php echo  Yii::t('app','Lire la suite');?></a></div>
