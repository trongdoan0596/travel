...
class Blogcate extends ActiveRecord {
    ...
    public function attributes(){
        return ['id','title','alias','parent_id','level','fulltxt','path','status','ordering','create_date','last_update','featured','img','icon','metakey','metadesc'];
    }
  public function rules()	{		
         return [
             [['id','title','alias','parent_id','level','fulltxt','path','status','ordering','create_date','last_update','featured','img','icon','metakey','metadesc'],'safe'],
