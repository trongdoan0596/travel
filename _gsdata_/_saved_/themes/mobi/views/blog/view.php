   ...
   <div class="uk-container-center">   
          <?php             
            if(!empty($model)){                  
                    ...
                    <div class="uk-width-1-1">    
                        <div class="blogcontent">
                            <ul class="uk-list">
                                ...
                                <li class="bypost uk-text-center"><?php echo Yii::t('app','Last update');?> <?php echo StringHelper::showMonthfr($date);?>   &nbsp&nbsp &nbsp&nbsp   <?php echo Yii::t('app','By');?>: <a href="#"><?php echo User::Getname($model->user_id);?></a></li>
                ...
                <?php echo Ortherblog::widget(array('view'=>'mobi','catblog_id'=>$model->catblog_id,'blog_id'=>$model->id,'limit'=>-1));?>
                <?php //echo Catblog::widget(array('view' =>'mobi'));?> 
                <?php echo Listcatblog::widget(array('view' =>'mobi','cat_id'=>27));?> 
