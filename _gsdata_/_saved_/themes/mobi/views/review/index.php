                ...
                ?>                  
                 <div class="boxitem"> 
                             ...
                             <div class="uk-text-center reviewcount">
                                   <!--  <span><?php //echo Yii::t('app', 'Nos clients parlent de nous');?></span>-->
                                     <br />
                           <?php
                             if(!empty($settings)){
                                ?>
                                 ...
                                 <?php
                                   ...
                                   ?>
                                   / <font class="totalrecord" style="padding-left:6px !important;font-size: 18px;"> <?php echo $totalcount;?></font> <?php echo  Yii::t('app','Avis');?>
                                 <br />
                                 <?php
                             }
                           ?>
