...
<div id="main" class="main-content"> 
  ...
  <?php
            ...
            <div class="boxinfo" style="margin-bottom:30px;"><?php echo $fulltxt;?></div>      
             ...
             <div class="uk-grid">
                    ...
                    <div class="uk-width-1-2" style="padding-left: 0px !important;padding-top:40px;">                             
                         <ul class="uk-list">
         ...
         <div class="uk-grid" style="margin-top: 0px;">
                <div class="uk-width-1-2">
                    <a href="<?php echo Url::base();?>/themes/web/img/press/full-mass-media-1.jpg" data-uk-lightbox><img src="<?php echo Url::base();?>/themes/web/img/press/mass-media-1.png" alt="Authentik Vietnam sur Le Progres" /></a> 
                </div>
                <div class="uk-width-1-2" style="padding-left: 0px !important;padding-top:40px;">                            
                      <ul class="uk-list">
          ...
          <div class="uk-align-center notreequipe" style="text-align: center;">
           ...
           <?php
             ...
             ?>
            <div class="boxenpress" style="margin-top: 30px;padding-top:30px;">                                
