              ...
              <div class="uk-grid">
                    <div class="uk-width-1-2">
                     ...
                     <div class="uk-width-1-2">
                       <div class="uk-grid">
                            <div class="uk-width-1-2">
                              <a href="https://www.routard.com/forum_message/4762903/demande_d_experience_sur_authentik_vietnam.htm#4762903" target="_blank"><img src="<?php echo Url::base();?>/themes/web/img/press/routard.png" alt="Recommandé par Le Routard" /></a> 
                            </div>
                            <div class="uk-width-1-2" style="padding-left: 0px !important;padding-top:80px;">                            
                                 <ul class="uk-list">
                                        <li class="titleitem">Recommandé par Le Routard</li>
                                        <li class="dateitem">05/2017</li>
                                        <li class="readmore"><a target="_blank" href="https://www.routard.com/forum_message/4762903/demande_d_experience_sur_authentik_vietnam.htm#4762903"><?php echo Yii::t('app', 'Read more');?></a></li>
                                  </ul>  
                            </div>
                        </div>   
                     </div>
