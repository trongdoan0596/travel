          ...
          <div class="uk-grid">
                <div class="uk-width-2-3">  
                  <div class="infomation">
                    <div class="introtxt">
          Si vous avez la moindre question ou information complémentaire à nous faire parvenir, merci de nous envoyer un mail à <b><a href="mailto:info@authentikvietnam.com">info@authentikvietnam.com</a></b>, ou remplissez le formulaire ci-dessous. Votre demande sera traitée dans les plus brefs délais.<br />
                ...
                <?php if(Yii::$app->session->getFlash('msg')):?>                    
                     ...
                     <?php echo $form->errorSummary($model,array("id"=>"errorctid","class"=>"uk-container-center errorsummary"));?>                                        
                      <div class="uk-form-row">
                         ...
                         <div class="uk-form-row">                                
                             <?php echo $form->field($model,'title')->textInput(array('class' =>'form-control','autofocus' => true,'placeholder'=>''));?> 
                         </div>                         
                         <div class="uk-form-row">
                         ...
                         <div class="uk-form-row">
                          ...
                          <div class="uk-form-row">                         
                             <label class="control-label" for="requestpriceform-how_did_id" style="height: 90px !important;"><?php echo Yii::t('app', 'How did you find us');?></label> 
                             <?php
                                     $allhowdid = $model->getAllHowDidUs();
                                     if(!empty($allhowdid)){
                                        $i=1;
                                        foreach ($allhowdid as $key => $value){                                                                          
                                            ?>   
                                             <div class="radio-item" style="width:180px !important;">
                                                 <input data-id="0" type="radio" id="contactform-how_did_id<?php echo $key;?>" name="ContactForm[how_did_id]" value="<?php echo $key;?>" />
                                                 <label for="contactform-how_did_id<?php echo $key;?>" style="text-align: left;"><?php echo $value;?></label>
                                             </div>                                                                                    
                                            <?php
                                           // if($i==3) echo '<br />';
                                            $i++;
                     ...
                     <div class="uk-width-1-1" style="padding: 15px;">
                        <h2>Authentik Vietnam Co.,Ltd</h2>
                         <ul class="uk-grid contactbox">
                              <li class="address-footer"><label><i class="uk-icon-home uk-icon-small"></i></label><font style="padding-left:0px;margin-top: -30px;">3 Phan Huy Ích, Nguyễn Trung Trực, <br />Ba Dinh District, Hà Nội, Vietnam (4e étage).</font></li>   
                              ...
                              <li><label><i class="uk-icon-envelope-o"></i></label><a href="mailto:info@authentikvietnam.com">info@authentikvietnam.com</a></li>
                              <li><label style="float: left;"><i class="internet"></i></label><a href="https://authentikvietnam.com">www.authentikvietnam.com</a></li>
                        </ul>                      
                     </div>
                      <div class="uk-width-1-1" style="padding: 15px;">
