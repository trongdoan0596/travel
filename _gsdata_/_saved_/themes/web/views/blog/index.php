                                   ...
                                   <?php
                                       ...
                                       if(!empty($info) && $cid==0){
                                          ...
                                          <div class="boxinfo" style="margin-top: -8px !important;">
                                             ...
                                             <div class="introtxt" style="padding-bottom:0px !important; margin-bottom:0px !important;background: none !important;padding-right:24px;padding-top: 0px; padding-left: 0px !important;"><?php echo $fulltxt;?></div>                                          
                                             <hr/>
                                          </div>
