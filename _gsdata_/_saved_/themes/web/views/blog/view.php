      ...
      <div class="viewboxblog">     
          ...
          <?php             
            if(!empty($model)){      
                ...
                $date_fr = StringHelper::showDateMfr($model->last_update,1);//StringHelper::showDateMfr($model->create_date,1);
                ...
                <script type="application/ld+json">
                    {
                      ...
                      "author": {"@type": "Person","name": "<?php echo $authorname;?>"},
                      "publisher": {
                      "@type": "Organization",
                    ...
                    <div class="uk-width-2-3">    
                        <div class="blogcontent">
                            <ul class="uk-list">
                                ...
                                <li><h1 class="titleblog"><?php echo $title;?></h1></li>
                                <li class="bypost"><?php echo Yii::t('app','Last update');?> <?php echo $date_fr;?>   &nbsp&nbsp &nbsp&nbsp   <?php echo Yii::t('app','By');?>: <a href="#"><?php echo $authorname;?></a></li>
                        ...
                        <div class="uk-grid">
                            <div class="uk-width-1-2">
                                <a href="#boxcommentblog" class="writecomment" data-uk-modal><?php echo Yii::t('app','Un commentaire à laisser ?');?></a>
                             </div>
                            <div class="uk-width-1-2">
