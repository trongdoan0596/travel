            ...
            if(!empty($rows)){                       
                ...
                ?>                  
                 <div class="boxitem"> 
                             ...
                             <div class="txt">
                                  ...
                                  if($img_head!=""){
                                    ...
                                    <div class="uk-width-3-4"><?php echo $fulltxt;?>                                       
                                       ...
                                       <div class="starfb">
                                           <i class="uk-icon-star"></i><i class="uk-icon-star"></i><i class="uk-icon-star"></i><i class="uk-icon-star"></i><i class="uk-icon-star"></i> 5/5 <?php echo Yii::t('app','Calculé sur les avis de nos clients sur');?> <a target="_blank" title="Tripadvisor Authentikvietnam" href="https://www.tripadvisor.fr/Attraction_Review-g293924-d11641267-Reviews-Authentik_Vietnam_travel-Hanoi.html">Tripadvisor</a>
                                       </div> 
                                       <div class="starfb">
                                        <i class="uk-icon-star"></i><i class="uk-icon-star"></i><i class="uk-icon-star"></i><i class="uk-icon-star"></i><i class="uk-icon-star"></i> 5/5 <?php echo Yii::t('app','Calculé sur {totalcount}  avis de nos clients sur notre site',array('totalcount' =>$totalcount));?>
                                       </div>                                       
                                    </div>                                    
                                    <?php
                                  }else{
                      ...
                      <?php //echo $this->render('_review',array('settings'=>$settings,'totalcount'=>$totalcount));?> 
                </div>
           <?php
             }else{
                echo "Updating!";
     ...
     <div class="uk-container uk-container-center">   
             <div class="listitem">                     
               ...
               <div class="reviewsubmit" align="center">
                <?php echo Html::a('<i class="uk-icon-edit"></i> '.Yii::t('app','Write a review'),array('#'), array('class' => 'btn btn-warning btnwrite')) ?>
                <br />
                </div>
