...
<div class="item">
    ...
    <div class="uk-grid">
            <div class="uk-width-2-5">
                 <a class="hover-effect"  href="<?php echo $title;?>">
                     <img  src="<?php echo $img;?>" alt="<?php echo $title;?>" />                     
                </a>
            </div>            
            <div class="uk-width-3-5"> 
               <?php echo $introtxt.'<br /> <a href="'.$url.'">'.Yii::t('app', 'Read more').' &nbsp;<i class="uk-icon-long-arrow-right"></i></a>';//StringHelper::Subwords($introtxt,26);?>
            </div>
   </div>                             
</div>