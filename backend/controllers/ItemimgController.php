           ...
           if(!empty($files)){
                ...
                foreach ($files as $file) {
                    ...
                    if (in_array ($ext,$ext_img)) {  
                        ...
                        $fileName = str_replace(" ","-",strtolower($name));//md5($file->baseName).'.'.$file->extension;
                        $arr_name[$i] = $fileName;
                        ...
                        Image::getImagine()->open($pathfile)->thumbnail(new Box(550,350))->save($pathfile_thumb ,array('quality' =>60));                                  
