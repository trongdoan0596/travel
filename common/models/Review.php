...
class Review extends ActiveRecord { 
            ...
            //array( array('title'), 'required'),
             ...
             array(
                  array('id','user_id','title','alias','introtxt','fulltxt','img_default',
                        ...
                        'ordering','last_update','create_date','lang','user_create','user_modify'
                       ),
                  'safe'
             ),
	...
	public function search($params){
             ...
             $sql->andWhere($this->tableName().'.lang = "'.$lang.'"');	       
 ...
 public static function createUrl($data=array(),$params = array()){		
		...
		return Url::toRoute(array('review/view','title'=>$params['title'],'language'=>$params['language']));       
	}     
/*************Front End**********************/
...
public static function getLastReview($limit=5,$orderby='id desc',$fields=''){ 
        ...
        $sql->where(Review::tableName().'.status =:status AND '.Review::tableName().'.lang =:lang',array(':status' => 1,':lang' =>$lang));       
