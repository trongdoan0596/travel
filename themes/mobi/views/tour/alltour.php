...
<div class="boxtour">                 
      <?php
        if(!empty($info)){
            ...
            <div class="infocate">                                             
                <div class="content"> 
                    <?php  echo $info->fulltxt;//HtmlPurifier::process($info->fulltxt);?>
                 </div>                             
             </div>   
      <?php                         
        }
         ...
         <h2><?php echo Yii::t('app', 'Tour Filter');?></h2>                                     
                    <div class="item"> 
                     ...
                     <div class="item">                               
                      <?php //echo Yii::t('app', 'Catégorie de voyage ');?>
                          <select name="cat_id" id="cat_id" class="slcfillter">
                           <option value="0">---<?php echo Yii::t('app', 'Catégorie de voyage');?>---</option>
                            <?php
                              if(!empty($cattour)){             
                     ...
                     <div class="item" style="margin-top:20px !important;">
                         <input type="submit" class="btnfilter" value="<?php echo Yii::t('app', 'Filter');?>" />
                     </div>
        </form>
  </div>    
