                    ...
                    <div class="uk-width-1-3">
                         <div class="boximg">
                          <?php
                           ...
                           ?>
                           <img class="uk-border-circle" src="<?php echo $img;?>" alt="<?php echo $model->title;//Html::encode($model->title);?>" />
                         </div>                
                    </div>
                    <div class="uk-width-2-3">
                        <div class="title">
                           <h1><?php echo $model->title;//Html::encode($model->title);?> <span> - <?php echo $model->profession;//Html::encode($model->profession);?></span></h1> 
                        </div>    
