                ...
                ?>                  
                 <div class="boxitem"> 
                             ...
                             <div class="txt">
                                  ...
                                  if($img_head!=""){
                                    ...
                                    <div class="uk-width-1-4">
                                      <a rel="nofollow" href="https://www.tripadvisor.com/Attraction_Review-g293924-d11641267-Reviews-Authentik_Vietnam_Travel-Hanoi.html" target="_blank"><img src="<?php echo $img_head;?>"/>
                                      </a>
                                      </div>
                        ...
                        <div class="reviewcount">
                           <span><b class="numberreview"><?php echo $totalcount;?></b> <?php echo Yii::t('app', 'reviews from our community');?></span>
                        </div>  
                </div>
           <?php
             }else{
