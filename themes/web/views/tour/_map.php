...
<div class="contryside">
            <h1 style="display: none;">
             <?php
              if($model->metatitle!=''){
                    echo $model->metatitle;
                }else{
                    echo $model->title;
                }
              ?>
            </h1>    
            <h2><?php echo $model->title;?> - <?php echo $num_day.' '.Yii::t('app', 'Day');?>s</h2>
            <div class="uk-grid boxmap">               
                   <div class="uk-width-1-2 map  <?php echo $clssbgmap;?>">
                                    <h2><?php echo Yii::t('app', 'You will discover');?></h2>
                                     <!-- begin map-->
                                      ...
                                      if($model->imgmap !=''){
                                        ...
                                        ?>
                                        <li>                                        
                                            <img src="<?php echo $imgmap;?>" alt="<?php echo $model->title;?> - <?php echo $num_day.' '.Yii::t('app', 'Day');?>s" />
                                        </li>
                                        <?php
                                      }else{
                                      ?>
                                    ...
                                    <div class="uk-width-1-2 content">
                                     <h2><?php echo Yii::t('app', 'Tour Briefing');?></h2>
                                       <ul class="uk-list uk-scrollable-box uk-list-line">
                                       <?php
                                       if(!empty($details)){
