...
<div class="boxinfo"><font class="datetxt"><?php echo Yii::t('app', 'Last update').' '.$date_fr;?></font> <?php echo Yii::t('app', 'in');?> <a href="<?php echo $urlblog;?>"><font class="catetxt"><?php echo $catblog_name;?></font></a> <font class="catetxt"><!--Comment (52)--></font></div>
<div class="uk-grid">
