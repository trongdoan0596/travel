                ...
                <ul class="uk-list">
                       ...
                       <li class="uk-display-inline-block"> 
                         ...
                         <li style="vertical-align: top;">
                          <?php echo $form->field($modelform,'verifyCode')->widget(Captcha::className(),array('template' =>'<div class="captchacode"><div class="col-code">{input}</div><div class="col-img">{image}<br /><div style="white-space: nowrap;">'.Yii::t('app','You must type the characters of the image in the text box').'</div></div></div>',)); ?>
                         </li>                        
                        <?php 
